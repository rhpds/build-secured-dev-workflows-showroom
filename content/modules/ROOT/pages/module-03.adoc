...
. Click *Create*. You'll see a pop-up message saying "The user has been created."
+
...
. Click *Set Password*. You'll see a pop-up message saying "The password has been set successfully."
+
...
. Click the *RHDH* tab in the Showroom. You may need to refresh the tab. You should immediately notice that Guest access is no longer available and the only login option is now Sign in with OIDC, backed by Red Hat Build of Keycloak.
