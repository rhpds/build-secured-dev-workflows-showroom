...
image::rhtpa_packages.png[rhtpa_packages,align="center"]

* Switch to the *Vulnerabilities* tab. You will notice that the view is currently empty.

image::rhtpa_vulnerabilities.png[rhtpa_vulnerabilities,align="center"]
...
image::rhtpa_importers.png[rhtpa_importers,align="center"]
...
image::rhtpa_vulnerabilities_complete.png[rhtpa_vulnerabilities_complete,align="center"]
