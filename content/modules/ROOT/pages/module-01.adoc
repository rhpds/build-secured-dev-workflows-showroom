...
* *RHTPA* is Red Hat’s supported distribution of the upstream link:https://github.com/guacsec/trustify[*trustify  project*,window=_blank] project, which is part of the link:https://guac.sh/trustify/[*GUAC Community*,window=_blank] (Graph for Understanding Artifact Composition).
...
* Where an SBOM describes *what* is in the software, an attestation proves *how, when and by whom* it was built. You will learn more about attestation in module 2.
