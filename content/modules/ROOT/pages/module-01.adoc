...
* On the left-hand side, you’ll find the workshop guide, including all the modules and steps you’ll complete today. 
* On the right-hand side, you’ll find the tools required to complete the labs, including a Terminal, the OpenShift Console, and a lot more.
...
* Along the way, you will see sections marked with the following callout in the header:  *`Optional Deep Dive 🔍`*
...
image::refresh_rhbk.png[refresh_rhbk,align="center"]
