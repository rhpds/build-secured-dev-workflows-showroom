...
. *Right Click* the link for *OpenShift Dev Spaces (VSCode)* and choose *Open in Incognitio Window*. This will launch your cloud-based development environment in a separate browser window.
+
