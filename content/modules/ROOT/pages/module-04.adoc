...
* link:developer_hub_url[Right click this link], then open it in a new private browsing session.
...
. Return to Red Hat Developer Hub (RHDH) in Showroom and select the *my-quarkus-tkn* Component in the *Catalog*.
