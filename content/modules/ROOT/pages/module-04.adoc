...
* These templates embed the guardrails established in the earlier modules by design. SBOM generation and analysis, code and image signing, vulnerability scanning, and Enterprise Contract policy checks are all included by default.
...
* By the end of this module, you will see how RHADS turns trusted building blocks into repeatable, production-ready Golden Paths. Every application starts secure. Every promotion is governed. And teams move fast without bypassing trust.
...
=== Configure ACS - Quay Integration
...
== Step 2: Configure Git Signing in OpenShift Dev Spaces
...
== Step 3: Execute the Software template

===  Step introduction

* Up to this point, you have been working as a platform engineer.
