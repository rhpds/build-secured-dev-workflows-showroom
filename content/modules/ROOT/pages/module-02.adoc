...
* *RHTAS* is an enterprise deployment of the link:https://www.sigstore.dev[*Sigstore project*,window=_blank]. 
...
* Next you will create a new client, in the left navigation menu, click *Clients*, then click *Create client*.
...
. Click *Save*.
* You’ll see a pop-up message saying “Client saved successfully".
...
image::tas_client_service_account_details.png[tas_client_service_account_details,align="center"]
...
* Run the follwoing commands in the Showroom terminal:
...
=== 6.3 Verify Certifiacte and Attestation in Rekor search UI
...
=== 6.4 Verify the Signed image in Quay
