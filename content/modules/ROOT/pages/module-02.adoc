...
* It supports keyless signing (associates identities, rather than keys, with an artifact signature) via OIDC, and also key-based workflows when required in tightly controlled environments.
